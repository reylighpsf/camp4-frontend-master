    ...
    <main className="member-page">
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .member-notification { align-items: center; background: #d4d2ec; border: 0; border-radius: 50%; color: #050505; cursor: pointer; display: inline-flex; height: 64px; justify-content: center; position: relative; width: 64px; }
        .member-notification:hover, .member-notification.is-open { background: #c6c3e7; }
        .member-notification svg { height: 31px; width: 31px; }
        .member-notification-badge { align-items: center; background: #ff6b20; border: 2px solid #f4f5f9; border-radius: 999px; color: #fff; display: inline-flex; font-size: 10px; font-weight: 900; height: 22px; justify-content: center; min-width: 22px; padding: 0 5px; position: absolute; right: -2px; top: -2px; }
        .member-notification-dropdown { background: #fff; border: 1px solid #d9dcef; border-radius: 8px; box-shadow: 0 18px 36px rgba(11,8,113,.18); color: #0b0871; overflow: hidden; position: absolute; right: 0; top: calc(100% + 12px); width: min(360px, calc(100vw - 32px)); z-index: 30; }
        .member-notification-head { align-items: center; border-bottom: 1px solid #eef0f7; display: flex; justify-content: space-between; gap: 12px; padding: 14px 16px; }
        .member-notification-head strong { font-size: 14px; font-weight: 900; }
        .member-notification-head span { color: #ff6b20; font-size: 11px; font-weight: 900; }
        .member-notification-list { display: grid; max-height: 320px; overflow-y: auto; }
        .member-notification-item { border-bottom: 1px solid #eef0f7; display: grid; gap: 5px; padding: 13px 16px; text-align: left; }
        .member-notification-item.is-unread { background: #fff8f3; }
        .member-notification-item strong { color: #0b0871; font-size: 13px; font-weight: 900; line-height: 1.25; }
        .member-notification-item p { color: #384076; font-size: 12px; font-weight: 700; line-height: 1.35; margin: 0; }
        .member-notification-item span { color: #7a80a3; font-size: 11px; font-weight: 800; }
        .member-notification-state { color: #7a80a3; font-size: 12px; font-weight: 800; padding: 18px 16px; text-align: center; }
        .member-notification-state.is-error { color: #c73822; }
        .member-notification-footer { background: #f8f9fd; border: 0; color: #ff6b20; cursor: pointer; font: inherit; font-size: 12px; font-weight: 900; min-height: 42px; width: 100%; }
